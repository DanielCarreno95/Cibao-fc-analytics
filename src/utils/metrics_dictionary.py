# =========================================================
# 📘 METRICS DICTIONARY — CIBAO FC DATA HUB
# =========================================================
# Mapeo de nombres futbolísticos (en español profesional)
# hacia nombres reales de las columnas del dataset.
# =========================================================

METRICS_DICT = {

    # =========================
    # 🏟️ INFORMACIÓN GENERAL DEL PARTIDO
    # =========================
    "Fecha": "Date",
    "Jornada": "Jornada",
    "Partido": "Match",
    ...
    "Porcentaje de pases largos (%)": "long_pass_percent",
