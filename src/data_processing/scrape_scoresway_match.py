        ...
        try:
            ...
            async def handle_response(response: Response):
                ...
                if 'performfeeds.com' in url and '/soccerdata/match/' in url:
                    try:
                        ...
                        print(f"    ⚠️  Error parsing PerformFeeds response: {e}")
            ...
            try:
                ...
                if match_stats_link:
                    ...
                    print(f"    ⚠️  Could not find Match Stats tab")
            except Exception as e:
            ...
            if not match_data:
                ...
                try:
                    ...
                    if page_data:
                        ...
                        print(f"    ⚠️  Could not find data in page context")
                ...
                if not match_data:
                    try:
                        ...
                        # Try known Opta API patterns
                        api_base = "https://widgets-api.ngdata.statsperform.com/widgets"
                        api_key = "auz3487aifIDFI835kadfjadoeaDj38"
                        ...
                        if response.status == 200:
                            ...
                            if body and len(body) > 1000:
                                ...
                                if inicio_json > 0 and final_json > 0 and inicio_json < final_json:
                                    ...
                                    print(f"    ⚠️  Response is not JSONP format")
                        elif response.status == 403 or response.status == 401:
                            print(f"    ⚠️  PerformFeeds requires authentication (status {response.status})")
                        else:
                            print(f"    ⚠️  PerformFeeds returned status {response.status}")
                    except Exception as e:
                ...
                if not match_data:
                    try:
                        ...
                        if match_data:
                            ...
                            print(f"    ⚠️  Match not found in team fixtures data. Found {len(captured_responses)} responses.")
