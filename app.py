...
def main_hub():
    ...
    # ======== SEPARADOR ========
    st.markdown("<hr style='margin-top:40px; margin-bottom:30px; opacity:0.25;'>", unsafe_allow_html=True)

    # ======== SECCIÓN COPA ========
    st.markdown("<h3 style='text-align:center; color:#ff7b00; margin-top:10px;'>ANÁLISIS COPA</h3>", unsafe_allow_html=True)
