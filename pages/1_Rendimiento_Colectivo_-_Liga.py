...
st.markdown("### 📥 Descargar reporte PDF (estructura completa)")

# Reutilizamos las definiciones de grupos de cada pestaña para el PDF
grupos_pases_pdf = {
    "Control y estabilidad en la circulación": {
        "Posesión (%)": "possession_percent",
        "Precisión de pase (%)": "passes_accurate_percent",
...
pdf_opponent = locals().get("opponent_choice")
pdf_x_metric = locals().get("x_column")
pdf_y_metric = locals().get("y_column")
